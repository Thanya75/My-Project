...
//query
$query=mysqli_query($conn,"SELECT COUNT(major_id) FROM `td_major`");
	...
	$nquery=mysqli_query($conn,"SELECT * from  td_major $limit");
...
<body>
    <div class="container">
        ...
        <form action="searchMajor.php" class="form-group" method="POST">
            ...
            <input type="text" placeholder="ป้อนข้อมูล" name="major_name" class="form-control"><br>
            <input type="submit" value="ค้นหา" class="btn btn-primary my-2">
        </form>

        <br>
        <a href="insert_major.php" class="btn btn-success">เพิ่มข้อมูล</a>
        <hr>
        <table id="mytable" class="table table-bordered table-striped">
            <thead>
                ...
                <th>สาขาวิชา</th>
                <th>คณะ</th>
                <th>เบอร์โทรสาขาวิชา</th>
            </thead>
            <tbody>
                <?php
                include_once('functions.php');
                $majordata = new DB_con();
                $sql = $majordata->majordata();
